<template>
  <div style="position: relative" class="wkdatepick">
      ...
      <div class="disflex">
        <div class="cusdate-header-timeone">
          ...
          <div  class="disflex cusdate-num">
            <div v-for="(item,index) in timeArrOne" :key="index" class="cusdate-num-item">{{item.name}}</div>
          </div>
        </div>
        <div class="cusdate-header-time">
          <div class="cusdate-total">12:00-24:00</div>
          <div  class="disflex cusdate-num">
            <div v-for="(item,index) in timeArrTwo" :key="index" class="cusdate-num-item">{{item.name}}</div>
          </div>
        </div>
      </div>
    </div>
    <div class="cusdate-body">
      <div class="w80 cusdate-body-left">
        <div v-for="(item,index) in dayArr" :key="index" class="cusdate-body-item">{{item.name}}</div>
      </div>
      <div>
        <div class="seats" :style="{width:seatWidth*rows+'px',height:seatHeight*columns+'px'}">
          ...
          <div v-for="(seat,index2) in seats" :key="index2" :id="seat.sid" class="seat">
            <!--title-->
  ...
  "></div>
    ...
    <div class="cusdate-select" v-if="selectedSeats.length>0">
      ...
      <div v-for="(item,index) in finalShowArr" :key="index" class="select-item">
        <div class="select-item-title">{{item.y}}</div>
        <div class="disflex select-item-right">
          <div class="select-item-time" v-for="(son,sonIndex) in item.xSummarylist" :key="sonIndex"> <span v-if="sonIndex!=0">、</span>{{son}}</div>
        </div>
      </div>
    </div>
